<template>
    <div class="f12 prepaid" id="prepaid">
            <div class="paid_content">
                ...
                <p class="service">
                    <a href="tencent://message/?uin=2067844913&Site=qq&Menu=yes" target="_blank"><img src="../../../images/wallet/service1.png" />&nbsp;</a>
                    <a href="tencent://message/?uin=3226209225&Site=qq&Menu=yes" target="_blank"><img src="../../../images/wallet/service2.png" /></a>
                </p>
            </div>

            <div class="tip1">
                <p class="wei_style" >方式一&nbsp;&nbsp;微信支付</p>
                ...
                <p style="float: left; margin-left: 10px; margin-top: 10px;" v-if="code"><span style="position: relative; top: -102px;">二维码</span><img v-bind:src="code" style="margin-left: 10px;" /></p>
            </div>
            <div class="tip2 tip1">
                <p >方式二&nbsp;&nbsp;履约预付费账号充值</p>
 ...
 #prepaid {
  padding-left: 20px;
    ...
    .tip1{
        ...
        .wei_style{
            background: url(../../../../static/wallet/1.png) no-repeat;
            height: 26px;
            line-height: 26px;
            font-size: 16px;
            color: #333;
    ...
    .tip2{
        ...
        p:nth-of-type(1){
             background: url(../../../../static/wallet/2.png) no-repeat;
             height: 26px;
            line-height: 26px;
            font-size: 16px;
            color: #333;
    ...
    .tip3{
        p:nth-of-type(1){
             background: url(../../../../static/wallet/3.png) no-repeat;
        }
        .go{
            a{
                font-size: 16px;
